    ...
    <div className="rounded-[3px] bg-white px-[24px] pb-[90px] pt-[30px] md:px-[30px]">
      ...
      <div className="mt-[14px] text-[16px] text-primary-black">
        ...
        <div className="mt-[14px] text-[16px] text-primary-black">
          <p>
            当ブログでは、Google
            Inc.が提供するアクセス解析ツール「Googleアナリティクス」を利用しています。Googleアナリティクスは、トラフィックデータの収集のためにCookieを使用しています。このトラフィックデータは匿名で収集されており、個人を特定するものではありません。この機能はCookieを無効にすることで収集を拒否することが出来ます。
          </p>
          <p className="mt-[6px]">
            Googleアナリティクスの詳細は
